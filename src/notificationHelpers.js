 ...
 * @param {string} type - Type of notification: 'like', 'comment', 'follow', 'tag'
 ...
 */
export async function createNotification(userId, type, actorId, actorName, postId = null, commentText = null) {
  try {
